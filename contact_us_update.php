<?php
    ...
    if(isset($_GET['updateid']))
      {
        ...
        $q_sel = "select * from contact_us where id='$id'";
    ...
    if(isset($_POST['sub']))
    {
        ...
        $em = $_POST['email'];
            ...
            $update = "update contact_us SET Name='$nm',Email='$em',Mobile_no='$mob',Message='$prblm';";
        ...
        if($Result)
        {
          echo '<script>alert("Data Updated Successfully..!")</script>';
            echo "<script>location.replace('admin_contact_us.php'); </script>";
        }
        else
        {
        ...
        <center style="margin-top:5%">
            <div class="connect">
                ...
                <div style="padding:50px">
                    <p style="display:inline-block;border-radius:50px;padding:60px;background-color:black;margin:1%"><img src="Images/rahul2.jpeg" style="border-radius:50px;height:400px;width:250px;margin:-4%;"><br><br><br><a href="" style="text-decoration:none;color:white;background-color:blue;padding:20px 20px;border-radius:70px;box-shadow:0px 0px 25px 10px white;">Connect Me</a></p>
                    <p style="display:inline-block;border-radius:50px;padding:60px;background-color:black;margin:1%"><img src="Images/parin2.jpeg" style="border-radius:50px;height:400px;width:250px;margin:-4%;"><br><br><br><a href="" style="text-decoration:none;color:white;background-color:blue;padding:20px 20px;border-radius:70px;box-shadow:0px 0px 25px 10px white;">Connect Me</a></p>
                    <p style="display:inline-block;border-radius:50px;padding:60px;background-color:black;margin:1%"><img src="Images/priyank2.jpg" style="border-radius:50px;height:400px;width:250px;margin:-4%;"><br><br><br><a href="" style="text-decoration:none;color:white;background-color:blue;padding:20px 20px;border-radius:70px;box-shadow:0px 0px 25px 10px white;">Connect Me</a></p>
                    <p style="display:inline-block;border-radius:50px;padding:60px;background-color:black;margin:1%"><img src="Images/riddhi2.jpeg" style="border-radius:50px;height:400px;width:250px;margin:-4%;"><br><br><br><a href="" style="text-decoration:none;color:white;background-color:blue;padding:20px 20px;border-radius:70px;box-shadow:0px 0px 25px 10px white;">Connect Me</a></p>
                </div>
            </div>
        </center>
       <div class="div1">
         ...
         <input  id="input1" type="text" name="name"  value="<?php echo $reg['Name'];?>" placeholder="Type Your Name Here" title="Name should be from [A-Za-z]"><br><br>

           <b><pre>Email Address *                   Phone no *</pre></b>
           <pre><input id="input2" type="email" name="email" placeholder="Type Your Email Id Here">     <input id="input2" type="text" name="phone" placeholder="Type Your Phone No. Here"pattern="[0-9]{10}" title="Number should be from [0-9]"></pre><br><br>
