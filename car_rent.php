    ...
    <body style="box-sizing:border-box">
        ...
        <div class="main" style="background:white">
            <div class="nav-bar" style="height:15%;">
                ...
                <div class="nav-list" style="margin-left:25%;">
                    
                    <ul>
                        
                        
                        <a href="contact_us.php" style="border-bottom:  rgb(0, 255, 221) solid 3px;color: aqua;"><li >Car Rent</li></a>
                        <a href="carrent_contact_us.php"><li>Contact us</li></a>
                        
                    </ul>
                    <p style="color:Green;float: center;font-size: 25px;margin-left: 205%;padding-top: 20px;">WELCOME</p>
                    <p style="margin-left:202%;"><?php  
                ...
                <!--<a href="car_sell.php" class="carsell" style="color:red;padding:0px 0px;border:3px solid white;border-radius:50px;background:white;font-size:40px;margin-left:40%;margin-top:0% "><i class ="fas fa-plus" >Sell</i></a>-->
            </div>
            <div class="dropdown">
    ...
    for (i = 0; i < dropdowns.length; i++) {
      ...
      if (openDropdown.classList.contains('show')) {
        openDropdown.classList.remove('show');
            ...
            <div class="head">
                <h1>Welcome to Car Rent...!</h1><br>
                <p>Hey...! If you want to Rent your Car.&nbsp&nbsp&nbsp&nbsp<a href="car_rent_form.php"><button type="button" name="click" id="click">Click here</button></a></p>
            </div>
            <div>
                <table class="table table-bordered" style="margin-top:5%;">  
                    ...
                    <div style="margin:2%; background:white;border-radius:50px">
                        ...
                        {?>
                        <div class="row" >
                          <div class="column" style="margin:1%;padding:60px;border:5px solid black;background:white;border-radius:50px;text-align:center;">
                            <!--<span style="margin:1%;padding:60px;border:5px solid black;background:white;border-radius:50px;">--> 
                            <?php echo '
                            
                            <img src="data:image/jpg;base64,'.base64_encode($row['image'] ).'" height="200" width="300"/>';?>
                            <h2 class="card-title" style=""><?php echo $row['car_name'];?></h2>
                            <h2 style="">Price: <?php echo $row['rs_per_km'];?>Rs/km</h2>
                            <h3 style="">TYPE: <?php echo $row['car_type'];?></h3><br>
                            <!--<h3 style="color:blue">Connect with Gmail :<a href="mailto: <?php echo $row[2];?>"> <?php echo $row[2];?></h3></a>-->
                            <!--<a href="" style="float:right;text-decoration:none;color:blue;font-size:20px;padding-top:10px;">Buy now</a>-->
                            <button class="open-button" onclick="openForm2()"><a href="rent_cardetails?rentid=<?php echo $row[0]; ?>"  style="text-decoration:none;background:green;padding:5px;
