            ...
            <div class="nav-bar">
                ...
                <div class="nav-list">
                    ...
                    <ul>
                        ...
                        <a href="car_rent.php"><li>Rent Car</li></a>
                        <a href="contact_us.php"><li style="border-bottom:  rgb(0, 255, 221) solid 3px;color: aqua;">Contact us</li></a>
                        
                    </ul>
                    <p style="color:Green;float: center;font-size: 25px;margin-left: 261.5%;padding-top: 20px;">WELCOME</p>
                    <p style="margin-left:258.5%;"><?php  
                ...
                <i style="font-size:40px;color:white;margin-left:35.5%;margin-top:-1.3% " class="fas fa-user-circle"></i>
            </div>
            <div class="dropdown">
    ...
    for (i = 0; i < dropdowns.length; i++) {
      ...
      if (openDropdown.classList.contains('show')) {
       ...
       <div class="div1">
         ...
         <input  id="input1" type="text" name="name" placeholder="Type Your Name Here"><br><br><br>

           <b><pre>Email Address *                   Phone no *</pre></b>
           <pre><input id="input2" type="email" name="email" placeholder="Type Your Email Id Here">     <input id="input2" type="text" name="phone" placeholder="Type Your Phone No. Here"></pre><br><br>
