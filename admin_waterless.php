...
<?php
	...
	$result = mysqli_query($connect,"SELECT * FROM registration ORDER BY id ASC LIMIT $start_from, $limit");
	$msg = "";
...
<div style="display:block">
	...
	<h2 style="color:white;background-color:black;width:500px;padding:20px;margin-left:35%;font-size:50px;text-align:center">Waterless Booked </h2>
	...
	<?php
		...
		?><tr id="mytr">
			...
			<td><a href="admin_waterless.php?delete_id=<?php echo $reg[0]; ?>" onclick="return confirm('Are you sure to delete !'); "  style="text-decoration:none;background:red;padding:5px;
					border:2px solid black;color:white">DELETE</a></td>
			<td><a href="waterless_update.php?updateid=<?php echo $reg[0]; ?>"  style="text-decoration:none;background:green;padding:5px;
