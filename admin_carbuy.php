...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$id=$_GET['delete_id'];
		$del = "delete from buy where Id='$id';";

		$Result = mysqli_query($connect,$del);
		if($Result)
		{
			echo "<script>location.replace('admin_carbuy.php');</script>";
...
<div style="display:block">
	...
	<h2 style="color:white;background-color:black;width:500px;padding:20px;margin-left:35%;font-size:50px;text-align:center">User Car Buy </h2>
</div>
	...
	<?php
		...
		?><tr id="mytr">
			...
			<td><a href="admin_carbuy.php?delete_id=<?php echo $reg[0]; ?>" onclick="return confirm('Are you sure to delete !'); "  style="text-decoration:none;background:red;padding:5px;
					border:2px solid black;color:white">DELETE</a></td>
			<td><a href="carbuy_update.php?updateid=<?php echo $reg[0]; ?>"  style="text-decoration:none;background:green;padding:5px;
