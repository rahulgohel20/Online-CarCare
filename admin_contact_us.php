...
<?php
	...
	$result = mysqli_query($connect,"SELECT * FROM contact_us ORDER BY id ASC LIMIT $start_from, $limit");
	$msg = "";
...
<div style="display:block">
	...
	<h2 style="color:white;background-color:black;width:500px;padding:20px;margin-left:35%;font-size:50px;text-align:center">Contact Us</h2>
</div>
	...
	<?php
		...
		?><tr id="mytr">
			...
			<td><a href="admin_contact_us.php?delete_id=<?php echo $reg[0]; ?>" onclick="return confirm('Are you sure to delete !'); "  style="text-decoration:none;background:red;padding:5px;
	...
	$result_db = mysqli_query($connect,"SELECT COUNT(id) FROM contact_us"); 
	...
	for ($i=1; $i<=$total_pages; $i++) {
				...
				<a class='page-link' style='text-decoration:none;color:black;border:1px solid black;padding:10px;background:white;margin-left:2450%' href='admin_contact_us.php?page=".$i."'>".$i."</a></li>";	
	}
