        ...
        <div class="nav-bar">
            ...
            <a href="home.php"><marquee direction="left" behavior="scroll" ><i class="fas fa-car"></i> Car Care <i class="fas fa-car"></i></marquee></a>
                ...
                <div class="nav-list">
                    ...
                    <p style="color:Green;float: center;font-size: 25px;margin-left: 160%;padding-top: 20px;">WELCOME</p>
                    <p style="margin-left:160%;"><?php  
                ...
                <i style="font-size:40px;color:white;margin-left:22%;margin-top:-1.5% " class="fas fa-user-circle"></i>
      ...
      if (openDropdown.classList.contains('show')) {
       ...
       <div class="div1">
         ...
         <input  id="input1" type="text" name="name" placeholder="Type Your Name Here"><br><br><br>
           ...
           <pre><input id="input2" type="email" name="email" placeholder="Type Your Email Id Here">     <input id="input2" type="text" name="phone" maxlength="10" placeholder="Type Your Phone No. Here"></pre><br><br>
