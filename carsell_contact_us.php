            ...
            <div class="nav-bar">
                ...
                <div class="nav-list">
                    ...
                    <ul>
                        ...
                        <a href="sell&buy.php"><li>Car Buy</li></a>
                ...
                <i style="font-size:40px;color:white;margin-left:35%;margin-top:-1.5% " class="fas fa-user-circle"></i>
            </div>
            <div class="dropdown">
    ...
    for (i = 0; i < dropdowns.length; i++) {
      ...
      if (openDropdown.classList.contains('show')) {
       ...
       <div class="div1">
         ...
         <input  id="input1" type="text" name="name" placeholder="Type Your Name Here" required><br><br><br>

           <b><pre>Email Address *                   Phone no *</pre></b>
           <pre><input id="input2" type="email" name="email" placeholder="Type Your Email Id Here" required>     <input id="input2" type="text" name="phone" placeholder="Type Your Phone No. Here" required></pre><br><br>

           <b><lable>Message *</lable></b><br>
           <input id="input3" type="text" name="message" placeholder="Type Your Message " required><br><br><br><br><br>

           <input id="input4" type="Submit" name="sub" value="Submit" style="background-color:red" required>       
        </form>
       </div>
       <div class="div2">
