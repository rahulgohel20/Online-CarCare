...
<div class="main">
    ...
    <div id="id01" class="modal">
        ...
        <form class="modal-content animate" action="" method="post">
            ...
            <input type="text" placeholder="Service station Name" name="sname" id="sname" title="Name should be from [A-Za-z]"  >
    ...
    <div id="id02" class="modal2">
        ...
        <form class="modal-content2 animate" action="" method="post">
            ...
            <div class="container">
            <label for="aname"><b>Service Station Name</b></label>
            <input type="text" placeholder="Service station Name" name="sname" id="sname" title="Name should be from [A-Za-z]" required>

            <label for="aname"><b>Email Address</b></label>
            <input type="email" placeholder="Enter Email" name="email" required>

            <label for="cre_psw"><b>Create Password</b></label>
            <input type="password" placeholder="Create Password" name="cre_psw" required>

            <label for="con_psw"><b>Confirm Password</b></label>
            <input type="password" placeholder="Confirm Password" name="con_psw" required>

            <label for="mobile"><b>Mobile</b></label>
            <input type="tel" placeholder="Enter Mobile No." name="mobile" maxlength="10" pattern="[0-9]{10}" title="Number should be from [0-9]" required>
...
{
	$email=mysqli_real_escape_string($connect,trim($_POST['email_login']));
	$password=mysqli_real_escape_string($connect,trim($_POST['psw']));
	$name=mysqli_real_escape_string($connect,trim($_POST['sname']));
    
	$query="SELECT * FROM service_station WHERE email='$email' AND Confirm_pass='$password';";
	...
	if($fire)
	{
		if(mysqli_num_rows($fire)==1)
		{
			...
			echo "<script>location.replace('service_station.php'); </script>";
