                                ...
                                if(isset($_GET['updateid']))
                                {
                                  ...
                                  $rowcount = mysqli_num_rows($result);
                                    ...
                                    <img src="data:image/jpg;base64,'.base64_encode($row['images'] ).'" height="500" width="700"/>';?></div>
                                        ...
                                        <p style="float:right;margin-right:31%;font-size:15px;margin-top:-25%"> <h1 style="float:right;margin-right:17%;font-size:20px;margin-top:-25%"><?php echo $row[14];?></h1>
                                      ...
                                      <button class="open-button" name="open-button" onclick="openForm()">PURCHASE</button>
                                        ...
                                        <br><div style="">
                                          ...
                                          <p style="color:black;margin-left:40%;margin-top:-3.4%">Car Type <br><h3 style="color:black;margin-left:40%;padding:2px;font-size:30px"><?php echo $row[9];?></h3></p>
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                margin-bottom:0%; font-size:20px; font-weight: 300;"> <b>Website: Car Care ©2021 Rahul Gohel, Parin Kuhada, Priyank Dodiya, Riddhi Chaniyara.</b> </p>
                            </td>
                        </tr>
                      </tbody>
                    </table>
